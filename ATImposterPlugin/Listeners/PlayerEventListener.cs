...
namespace ATImposterPlugin.Listeners
{
    public class PlayerEventListener : IEventListener
    {
        ...
        public PlayerEventListener(ILogger<ATImposterPlugin> logger)
        {
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation(e.PlayerControl.PlayerInfo.PlayerName + " spawned");
            ...
            Task.Run(async () =>
            {
                _logger.LogInformation("Starting player task.");
                ...
                */
                _logger.LogInformation("Stopping player task.");
            });
        }
        ...
        {
            _logger.LogInformation(e.PlayerControl.PlayerInfo.PlayerName + " destroyed");
        }
